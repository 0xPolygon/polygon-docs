...
!!!info
    ...
    Currently, there is a limit of 100 active validators at a time. For a detailed description on what a validator is, see [<ins>Validator</ins>](../operate-node/validator/architecture.md).
