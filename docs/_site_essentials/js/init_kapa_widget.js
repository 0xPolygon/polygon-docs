...
document.addEventListener('DOMContentLoaded', function () {
  ...
  script.setAttribute('data-button-image-height', '0rem');
  script.setAttribute('data-button-image-width', '0rem');
  ...
  script.setAttribute('data-font-size-sm', '0.75rem');
  script.setAttribute('data-query-input-font-size', '0.75rem');
  ...
  script.setAttribute('data-example-question-button-font-size', '0.65rem');

  script.setAttribute('data-button-text-font-size', '0.9rem');
  script.setAttribute('data-button-height', '2.5rem');
