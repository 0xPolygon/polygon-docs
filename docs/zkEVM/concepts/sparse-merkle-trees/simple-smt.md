...
<center>![A Single key-value pair SMT](../../../img/zkEVM/fig4-sngl-kv-eg.png){width=400px}</center>
...
<center>![Two key-value pairs SMT - Case 1](../../../img/zkEVM/fig5-a-mpt-kv-eg.png){width=400px}</center>
...
<center>![Two key-value pairs SMT - Case 2](../../../img/zkEVM/fig5-b-mpt-kv-eg.png){width=450px}</center>
...
<center>![Two key-value pairs SMT - Case 3](../../../img/zkEVM/fig5-c-mpt-kv-eg.png){width=550px}</center>
