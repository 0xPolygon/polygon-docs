...
![Successful forge build command](img/success-forge-build.png)

Now, test the build with `forge test`

![Testing Forge Build](img/test-forge-build.png)
...
![Successful Deploy Sbt.sol](img/success-deploy-sbtdotsol.png)
