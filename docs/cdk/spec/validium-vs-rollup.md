...
|        | Rollup                                                    | Validium                                                                           |
| ------------------------ | ----------------------------------------------------------- | ---------------------------------------------------------------------------------- |
| **Node type**            | [zkEVM node](https://github.com/0xPolygonHermez/cdk-erigon/releases/tag/v1.2.24) | [Validium node](https://github.com/0xPolygonHermez/cdk-erigon/releases): zkEVM node with validium extensions                  |
