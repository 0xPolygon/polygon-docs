...
<table>
  <tr>
    <td>
      <img alt="CDK Service Desk" src="docs/img/cdk/CDK-service-desk.png?raw=true" width="300" height="200"/>
    </td>
    <td>
      <img alt="Example Request" src="docs/img/cdk/Example-request.png?raw=true" width="300" height="200"/>
    </td>
  </tr>
  <tr>
